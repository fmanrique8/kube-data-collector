...
# kube_data_collector documentation build
...
from kube_data_collector import __version__ as release

# -- Project information -----------------------------------------------------

project = "kube_data_collector"
author = "Kedro"
...
htmlhelp_basename = "kube_data_collectordoc"
...
latex_documents = [
    (
        master_doc,
        "kube_data_collector.tex",
        "kube_data_collector Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "kube_data_collector",
        "Project kube_data_collector codebase.",
        "Data-Science",
    )
]
